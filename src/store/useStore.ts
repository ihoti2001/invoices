...
const defaultData: AppData = {
  clients: [
    ...
    },
    {
      id: 'c4',
      name: 'Emily Davis',
      email: 'emily@brightdesign.co',
      phone: '+1 555-0404',
      address: '321 Creative Lane',
      city: 'Austin',
      country: 'USA',
      company: 'Bright Design Co.',
  ...
  invoices: [
    {
      ...
      dueDate: '2026-02-15',
      lineItems: [
        { id: 'li1', description: 'Web Development Services', quantity: 40, rate: 125, amount: 5000 },
        { id: 'li2', description: 'UI/UX Design', quantity: 20, rate: 95, amount: 1900 },
      ],
      subtotal: 6900,
      taxRate: 10,
      taxAmount: 690,
    ...
    },
    {
      ...
      dueDate: '2026-03-01',
      lineItems: [
        { id: 'li3', description: 'SEO Consulting', quantity: 10, rate: 200, amount: 2000 },
        { id: 'li4', description: 'Content Strategy', quantity: 5, rate: 150, amount: 750 },
      ],
      subtotal: 2750,
      taxRate: 10,
      taxAmount: 275,
    ...
    },
    {
      ...
      dueDate: '2026-03-15',
      lineItems: [
        { id: 'li5', description: 'Mobile App Development', quantity: 60, rate: 150, amount: 9000 },
      ],
      subtotal: 9000,
      taxRate: 10,
      taxAmount: 900,
    ...
    },
    {
      ...
      dueDate: '2026-04-01',
      lineItems: [
        { id: 'li6', description: 'Brand Identity Design', quantity: 1, rate: 3500, amount: 3500 },
        { id: 'li7', description: 'Logo Design', quantity: 1, rate: 800, amount: 800 },
      ],
      subtotal: 4300,
      taxRate: 10,
      taxAmount: 430,
    ...
    },
    {
      ...
      dueDate: '2026-04-20',
      lineItems: [
        { id: 'li8', description: 'Maintenance & Support', quantity: 1, rate: 2000, amount: 2000 },
      ],
      subtotal: 2000,
      taxRate: 10,
      taxAmount: 200,
...
export function useStore() {
  ...
  const markInvoicePaid = (id: string) => {
    ...
    if (inv) addActivity(`Payment received from ${client?.company || client?.name} — $${inv.total.toLocaleString('en-US', { minimumFractionDigits: 2 })}`, 'payment');
  };
